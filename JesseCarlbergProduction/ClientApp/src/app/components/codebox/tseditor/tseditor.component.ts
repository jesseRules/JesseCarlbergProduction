...
@Component({
  selector: 'app-tseditor',
  templateUrl: './tseditor.component.html',
  styleUrls: ['./tseditor.component.scss']
})
export class TseditorComponent implements OnInit, AfterViewInit {
  ...
  public htmlCode = '';
  public editorTypeSelection = 'JavaScript';
