...
export class StyleeditorComponent implements OnInit, AfterViewInit {
  ...
  public htmlCode = '';
  public editorTypeSelection = 'CSS';
  ...
  validate(event) {
    ...
    if (this.code) {
      try {
        ...
        this.openSnackBar('Valid CSS', null);
        ...
        this.openSnackBar('Invalid CSS', 'Error');
      }
    } else {
      this.openSnackBar('No CSS', 'Error');
    }
  }
}
